...
export default new Vuex.Store({
  state: {
    itemsCategoria: [
      ...
      {
        id: "C02", text: "Bisutería", link: "#", img: "icon_zapatillas.svg", products: [
      ...
      {
        id: "C03", text: "Máquinas para Imprenta", link: "#", img: "icon_zapatillas.svg", products: [
      ...
      {
        id: "C04", text: "Ropa", link: "#", img: "icon_zapatillas.svg", products: [
      ...
      {
        id: "C05", text: "Repuestos de autos", link: "#", img: "icon_zapatillas.svg", products: [
      ...
      {
        id: "C06", text: "Iluminación", link: "#", img: "icon_zapatillas.svg", products: [
      ...
      {
        id: "C07", text: "Árticulos Deportivos", link: "#", img: "icon_zapatillas.svg", products: [
      ...
      {
        id: "C08", text: "Carteras y Bolsos", link: "#", img: "icon_zapatillas.svg", products: [
